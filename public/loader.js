    ...
    return {
      ...
      init: function () {
        if (document.body) {
          var a = document.querySelectorAll(
            Trustindex.getScriptSelector("loader")
          );
                ...
                if ((d.after(g), h.responseText)) {
                  ...
                  -1 !==
                    location.href.indexOf(
                      Trustindex.getCDNUrl() + "amp-widget"
                    ) &&
                    (k = k.replace(/<img/g, '<img crossorigin="anonymus"'));
                  k = Trustindex.createElementFromHTML(k);
                  var l = k[0];
                  l.setAttribute("data-no-translation", !0);
                  -1 !==
                    [17, 21, 52, 53].indexOf(
                      parseInt(l.getAttribute("data-layout-id"))
                    ) && document.body.appendChild(g);
                  g.replaceWith(l);
                  for (let n = 0; n < k.length; n++)
                    k[n].innerHTML && l.after(k[n]);
                  ...
                  if (
                    ...
                    if (!l.layout_id)
                      return (l.innerHTML = "Layout id not found!");
                    if (!l.container)
                      return (l.innerHTML = "Container id not found!");
                    k = null;
                    l.set_id &&
                      (k =
                        Trustindex.getCDNUrl() +
                        ...
                        l.set_id +
                        ".css");
                    k && -1 === Trustindex.loaded_css.indexOf(k)
                      ? (Trustindex.addCSS(k, function () {
                          l.style.display = "";
                          Trustindex.resize_widget(l);
                          Trustindex.init_pager(l);
                        }),
                        Trustindex.loaded_css.push(k))
                      : ((l.style.display = ""),
                        Trustindex.resize_widget(l),
                        Trustindex.init_pager(l));
                    ...
                    (k =
                      l.getAttribute("data-rich-snippet") ||
                      l.getAttribute("data-rich-snippet-url")) &&
                      0 ===
                  ...
                  (k = document.createComment(
                    "Trustindex widget (" + f + ") is empty here."
                  )),
                    g.replaceWith(k);
              else
          ...
          window.addEventListener("resize", function () {
            document.body.offsetWidth !== b &&
              ...
              (Trustindex.resizerTimeoutPointer = setTimeout(
          ...
          setTimeout(Trustindex.resize_widgets, 1e3);
          window.addEventListener("click", function (c) {
            !Trustindex.activePopups.length ||
              c.target.closest(".ti-dropdown-widget-inner") ||
              c.target.closest(".ti-popup-widget") ||
              c.target.closest(".ti-widget-container") ||
              (c.preventDefault(),
              Trustindex.activePopups.forEach((e) => {
                e.classList.remove("active");
                (e = e
                  .closest(".ti-widget")
                  .querySelector(
                    "a.ti-popup-header[href], a.ti-header[href]"
                  )) && e.classList.remove("active");
              }),
          ...
          document
            ...
            .forEach((c) => c.replaceWith(c.firstChild));
          return !0;
        }
      ...
      init_line: function (a) {
        ...
        if (b) {
          ...
          if ((c = b.querySelector(".dot")))
            (b = parseInt(b.offsetWidth / d)),
              1 > b && (b = 1),
              (c.style.width = b + "px"),
              (c.style.left = Math.ceil((a.pager_state_line / d) * 100) + "%");
        }
        return !0;
      },
      init_pager: function (a) {
        if (window.jQuery && a instanceof jQuery)
          ...
          !a.classList.contains("ti-certificate") &&
          ...
          0 <
            a
              ...
              .filter(
                (b) =>
                  -1 === ["ti-widget", "desktop", "mobile", "table"].indexOf(b)
              ).length && Trustindex.resize_widget(a);
          ...
          if (null !== a.pager_autoplay_timeout) {
            ...
            "left" === a.rotate_to &&
              ...
              (a.pager_state_line = a.pager_state),
            ...
            a.querySelectorAll(".ti-review-item").forEach(
            ...
            a.addEventListener(
              ...
              function (m) {
                if (
                  m.target.matches(".ti-controls .ti-next") ||
                  m.target.matches(".ti-controls .ti-prev")
                )
                  m.preventDefault(),
                    Trustindex.moverBtnClicked(
                      a,
                      m.target.classList.contains("ti-next"),
                      "manual",
                      500
                    );
              },
            ...
            let b,
              ...
              l = function (m) {
                ...
                e = m.touches[0].pageY;
                f = d = c = null;
                g = a.reviews_container_wrapper.querySelector(
              ...
              n = function (m) {
                ...
                if (!h && (10 < Math.abs(m) || k)) {
                  ...
                  f = p + m;
                  Trustindex.animateReviews(a, p + "px", f + "px", 0, !1);
                  a.slider_loop &&
                    ((m = b > c),
                    Trustindex.addClonedReviews(
                      a,
                      a.pager_state +
                        (m ? 1 : -1) * Math.ceil(Math.abs(c - b) / g),
                      m
                    ));
                  k = !0;
                }
              ...
              r = function (m) {
                if (k && !h)
                  if (b && c && 25 < Math.abs(b - c)) {
                    let q = b > c;
                    a.querySelectorAll(".ti-review-content").forEach(
                      (t) => (t.scrollTop = 0)
                    );
                    if ((q && a.isNext) || (!q && a.isPrev)) {
                      ...
                      var p =
                        (-1 *
                          (a.pager_state + m * (q ? 1 : -1)) *
                          a.reviews_container_wrapper.offsetWidth) /
                        Trustindex.getVisibleReviewNum(a);
                      p = parseInt(Math.abs(p - f));
                      p = parseInt((p / g) * 300);
                      Trustindex.moverBtnClicked(a, q, "manual", p, m);
                    } else
                      Trustindex.animateReviews(
                        a,
                        f + "px",
                        parseInt(a.pager_position) + "px",
                        120,
                        !1
                      ),
                        setTimeout(() => {
                          Trustindex.moverBtnClicked(
                            ...
                            "manual",
                            400,
                            Math.ceil(Math.abs(c - b) / g)
                          );
                        }, 120);
                  } else
                    f &&
                      f !== parseInt(a.pager_position) &&
                      Trustindex.animateReviews(
                        a,
                        f + "px",
                        parseInt(a.pager_position) + "px",
            ...
            a.reviews_container.removeEventListener("touchmove", n, {
              passive: !0,
            });
            ...
            a.addEventListener("click", function (b) {
              b.target.matches(".disable-widget")
                ? (b.preventDefault(),
                  ...
                  -1 === location.href.indexOf("widget/select_layout") &&
                    (document
                      .querySelectorAll(
                        '.ti-widget:not(.ti-feed-widget):not([data-layout-id="53"])'
                      )
                      .forEach((c) => c.classList.add("ti-disabled")),
                    53 != a.layout_id &&
              ...
              Trustindex.getCookie("ti-widget-disabled") &&
                document
                  .querySelectorAll(".ti-widget:not(.ti-feed-widget)")
                  .forEach((b) => b.classList.add("ti-disabled"));
          ...
          Trustindex.verifiedDisclaimerTooltipPosition(
            a.querySelector(".ti-verified-by")
          );
          return !0;
        }
      },
      removePopupEvents: function () {
        document
          .querySelectorAll(
            '.ti-widget:not(.ti-feed-widget) a[href="#popup"], .ti-widget:not(.ti-feed-widget) a[href="#dropdown"]'
          )
          .forEach(function (a) {
            let b = a.cloneNode(!0);
      ...
      moverBtnClicked: function (a, b, c, e, d) {
        ...
        if ("manual" === c && ((b && !a.isNext) || (!b && !a.isPrev)))
          return Trustindex.noReviewsAnimation(a, b);
        if (a.pager_moving || (a.mouse_over && "auto" === c)) return !1;
        let f = a.querySelectorAll(
            '.ti-review-item:not([style*="display: none"])'
          ).length,
          g = Trustindex.getVisibleReviewNum(a);
        return f <= g
          ? !1
          : Trustindex.moveReviews(
              a,
              a.pager_state + d * (b ? 1 : -1),
              c,
              e,
              b
            );
      ...
      moveReviews: function (a, b, c, e, d) {
        ...
        if (a.slider_loop) {
          ...
          0 > b &&
            ...
            setTimeout(function () {
              a.reviews_container_wrapper
                ...
                .forEach((h) => h.classList.remove("ti-cloned--dragging"));
          ...
          !0 === d
            ? (a.pager_state_line++,
              a.pager_state_line > g - 1 && (a.pager_state_line = 0))
            : !1 === d
            ? (a.pager_state_line--,
              0 > a.pager_state_line && (a.pager_state_line = g - 1))
            : (a.pager_state_line = b);
      ...
      addClonedReviews: function (a, b, c) {
        var e = Trustindex.getMaximumPagerState(a),
        ...
        if (b > e && (a.pager_state < b || "resize" === c)) {
          ...
          for (var g = 0; g < e; g++) {
            let h = a.reviews_container_wrapper
              .querySelectorAll(
        ...
        if (0 > b && !1 === c)
          for (
            e = a.reviews_container_wrapper.querySelectorAll(
              ".ti-review-item.ti-cloned.ti-cloned--start.ti-cloned--dragging"
            ).length,
              c = a.reviews_container_wrapper.querySelectorAll(
                ".ti-review-item.ti-cloned.ti-cloned--start"
              ).length,
              b = Math.abs(b - a.pager_state) - e,
              d = d - 1 - (c % d),
              c =
                a.reviews_container_wrapper.offsetWidth /
                Trustindex.getVisibleReviewNum(a),
              e = parseInt(a.reviews_container_wrapper.scrollLeft / c),
              f = 0;
            f < b;
            f++
          )
            (g = a.reviews_container_wrapper
              .querySelectorAll(
                '.ti-review-item:not(.ti-cloned):not([style*="display: none"])'
              )
              [d - f].cloneNode(!0)),
              ...
              (a.reviews_container_wrapper.scrollLeft = parseInt(
                (f + 1 + e) * c
              ));
      },
      ...
      animateReviews: function (a, b, c, e, d) {
        ...
        a.querySelectorAll(".ti-review-item").forEach(function (f) {
          f.animate(
            { left: [b, c] },
            { duration: e, fill: "both", easing: "ease-in-out" }
          );
          d &&
            setTimeout(() => {
          ...
          c &&
            c.forEach(function (e) {
              let d = e
                  ...
                  .querySelector(e.getAttribute("data-container")),
                f = 10;
              ...
              setTimeout(() => {
                ...
                g
                  ? (d.style.setProperty(
                    ...
                    d.setAttribute("data-initial-height", d.offsetHeight),
                    d.setAttribute("data-expanded-height", d.scrollHeight),
                    d.parentNode.classList.contains("ti-review-content") &&
                      ((d.parentNode.style.display = "block"),
                      d.parentNode.style.setProperty(
                        "-webkit-line-clamp",
                        "unset",
                        "important"
                      )),
                    0 <
                      ...
                      d.style.setProperty("max-height", "unset", "important"),
                    e.getAttribute("data-open-text") &&
                      (e.innerHTML =
                        '<span class="ti-read-more-active">' +
                        e.getAttribute("data-open-text") +
                        "</span>"),
                    e.setAttribute("style", ""))
                  : e.getAttribute("data-container") &&
                    ((e.innerHTML = "<span>&nbsp;</span>"),
                    (e.style.opacity = 0),
                    (e.style.pointerEvents = "none"),
                    c.length ===
                      a.reviews_container.querySelectorAll(
                        '.ti-read-more[style*="opacity: 0"]'
                      ).length && c.forEach((h) => (h.style.display = "none")));
              }, f);
            });
      ...
      readMoreHandler: function (a) {
        if (a.target.matches(".ti-read-more-active")) {
          ...
          let b = a
            .closest(".ti-review-item")
            .querySelector(a.parentNode.getAttribute("data-container"));
          a.classList.contains("ti-read-more-collapse")
            ? (b.style.setProperty("-webkit-line-clamp", ""),
              ...
              (a.innerHTML = a.parentNode.getAttribute("data-open-text")),
              a.classList.remove("ti-read-more-collapse"))
            : (b.style.setProperty("-webkit-line-clamp", "unset", "important"),
              b.style.setProperty(
                "height",
                b.getAttribute("data-expanded-height") + "px",
                "important"
              ),
              (a.innerHTML = a.parentNode.getAttribute("data-collapse-text")),
      ...
      handleSubContents: function (a) {
        a.querySelectorAll("a[data-subcontent]").forEach(function (b) {
          ...
          if (e) {
            if ("" !== e.innerHTML.trim())
              return b.setAttribute("data-subcontent-loaded", !0);
      ...
      formatReviews: function (a) {
        let b = document;
        void 0 !== a && (b = a);
        let c = b.querySelectorAll(
          ".ti-widget:not(.ti-feed-widget) .ti-review-content, .ti-widget:not(.ti-feed-widget) .ti-inner .ti-review-text"
        );
        c.forEach(function (e) {
          var d = e.querySelector(".ti-inner");
          d && (e = d);
          ...
          0 === d.length &&
            ...
            (d = e.querySelectorAll("svg")));
          if (d.length) {
            let g = 0.95 * parseInt(e.style.fontSize || 14);
          ...
          f &&
            setTimeout(
              () =>
                Trustindex.loadSpriteImage(
                  f.querySelector(".ti-profile-img-sprite")
                ),
              50
            );
        });
        setTimeout(() => {
          b.querySelectorAll(
            ".ti-widget:not(.ti-feed-widget) .ti-company-sprite-profile-image"
          ).forEach(Trustindex.loadSpriteImage);
        }, 50);
        void 0 === a &&
          ((c = document.querySelectorAll(
            ".ti-widget:not(.ti-feed-widget) .ti-review-item[data-platform-page-url]"
          )),
          c.forEach(function (e) {
          ...
          (c = document.querySelectorAll(
            ".ti-widget:not(.ti-feed-widget) .ti-review-item[data-time]"
          )),
          c.forEach(function (e) {
            let d = e.querySelector(".ti-date:not(.ti-date-comment)");
            if (d) {
              let f = parseInt(e.getAttribute("data-time"));
              d.innerHTML = Trustindex.getRelativeTime(
                f,
                e.closest(".ti-widget").getAttribute("data-time-locale")
              );
            }
          }));
        return !0;
      ...
      replaceErrorImages: function () {
        let a = document.querySelectorAll(
          ".ti-widget:not(.ti-feed-widget) .ti-review-item .ti-profile-img img"
        );
        a &&
          a.forEach(function (b) {
            if (
      ...
      initHeaderNav: function (a) {
        let b = a.querySelector(".ti-widget-header .ti-platform-tabs");
        if (b)
          if (
            b.querySelector(".ti-platform-tab-items").scrollWidth >
            b.offsetWidth
          ) {
            let c = b.querySelector(".ti-tab-active");
            c.previousElementSibling
              ? (b.querySelector(".ti-arrow-prev").style.display =
                  "inline-block")
              : (b.querySelector(".ti-arrow-prev").style.display = "");
            c.nextElementSibling
              ? (b.querySelector(".ti-arrow-next").style.display =
                  "inline-block")
              : (b.querySelector(".ti-arrow-next").style.display = "");
          } else
            (b.querySelector(".ti-arrow-prev").style.display = ""),
        ...
        Trustindex.verifiedDisclaimerTooltipPosition(
          a.querySelector(
            ".ti-widget-header .ti-header-content.ti-active .ti-verified-by"
          )
        );
        return !0;
      },
        ...
        b.addEventListener(
          ...
          function (c) {
            if (c.target.matches(".ti-platform-tab-items .ti-tab-item")) {
              ...
              d.querySelectorAll(".ti-tab-item").forEach((k) =>
                k.classList.remove("ti-tab-active")
              );
              ...
              let g = a.querySelector(
                ...
                h = a.querySelector(
                  ".ti-widget-header .ti-header-content.source-" + f
                );
              g && g.classList.remove("ti-active");
              h && h.classList.add("ti-active");
              a.querySelectorAll(".ti-review-item.ti-cloned").forEach((k) =>
                k.remove()
              );
              "all" === f
                ? a
                    .querySelectorAll(".ti-review-item")
                    .forEach((k) => (k.style.display = ""))
                : (a
                    .querySelectorAll(".ti-review-item")
                    .forEach((k) => (k.style.display = "none")),
                  a
                    .querySelectorAll(".ti-review-item.source-" + f)
                    .forEach((k) => (k.style.display = "")));
              d.scroll({ left: e.offsetLeft - 28, behavior: "smooth" });
              Trustindex.initHeaderNav(a);
              Trustindex.moveReviews(a, 0, "auto", 0, "resize");
              Trustindex.vertical_separate_reviews(a);
              Trustindex.setLoadMore(a);
            }
            c.target.matches(".ti-platform-tab-nav .ti-arrow-prev") &&
              (e = c.target
                .closest(".ti-platform-tabs")
                .querySelector(".ti-tab-active")) &&
              e.previousElementSibling &&
              e.previousElementSibling.click();
            c.target.matches(".ti-platform-tab-nav .ti-arrow-next") &&
              (c = c.target
                .closest(".ti-platform-tabs")
                .querySelector(".ti-tab-active")) &&
              c.nextElementSibling &&
      ...
      verifiedDisclaimerTooltipPosition: function (a) {
        if (!a) return !1;
        a.removeEventListener(
          "mouseenter",
          Trustindex.verifiedDisclaimerTooltipMouseEnterCallback
        );
        a.addEventListener(
          "mouseenter",
          Trustindex.verifiedDisclaimerTooltipMouseEnterCallback
      ...
      verifiedDisclaimerTooltipMouseEnterCallback: function (a) {
        a = a.target.nextElementSibling;
        a.classList.remove("ti-bottom");
        0 > a.getBoundingClientRect().y && a.classList.add("ti-bottom");
      },
      setLoadMore: function (a) {
        let b = a.querySelector(".ti-load-more-reviews-button");
        if (b) {
          let e = Trustindex.getLoadMoreLimit(a);
          b.style.display = "";
          a.querySelectorAll(".ti-review-item").forEach((f) =>
            f.classList.remove("ti-hide")
          );
          let d = function (f) {
            f.forEach((g, h) => {
      ...
      loadMoreHandle: function (a) {
        ...
        let b = a.closest(".ti-widget"),
          ...
          e = function (f) {
            for (let g = 0; g < f.length && !(g >= c); g++)
              f[g].classList.remove("ti-hide");
          };
        if (b.getAttribute("data-column-vertical-separate")) {
          ...
          for (d = 0; d < f.length; d++)
            e(f[d].querySelectorAll(".ti-review-item.ti-hide"));
        } else e(b.querySelectorAll(".ti-review-item.ti-hide"));
        0 === b.querySelectorAll(".ti-review-item.ti-hide").length &&
          ...
          if (c) {
            ...
            b.setAttribute(
              ...
              "ti-ai-summary-item " +
                b
                  ...
                  .replace(/source-[^\s]+/, "")
                  .trim() +
                (-1 !== d.text.indexOf("<li>") ? " ti-with-checklist" : "")
            );
            if ((c = b.querySelector(".ti-profile-details .ti-name")))
              c.innerHTML = d.title;
            if ((c = b.querySelector(".ti-profile-img"))) {
              ...
              if (0 < d.images.length) {
                ...
                e = f.cloneNode(!0);
                e.src =
                  Trustindex.getCDNUrl() + "assets/img/ai-profile-image.svg";
                c.appendChild(e);
                f.remove();
              } else
                (f.src =
                  Trustindex.getCDNUrl() + "assets/img/ai-profile-image.svg"),
                  f.setAttribute("alt", ""),
                  f.classList.add("ti-ai-profile-img");
            }
            (c = b.querySelector(".ti-stars")) && c.remove();
            if ((c = b.querySelector(".ti-profile-details .ti-date")))
              c.innerHTML = d.comment;
            if ((c = b.querySelector(".ti-review-text-container")))
              c.innerHTML = d.text;
            a.querySelector(".ti-reviews-container-wrapper").insertBefore(
              b,
              a.querySelector(".ti-reviews-container-wrapper").firstChild
            );
          }
        }
      },
      resize_widget: function (a) {
        ...
        if (a.container) {
          ...
          do {
            ...
            e.clientWidth &&
              ((d = window.getComputedStyle(e, null)),
              (d =
                e.clientWidth -
                parseFloat(d.paddingLeft) -
                parseFloat(d.paddingRight)));
          } while (100 > d);
          "100%" === c && b > d && d && (a.style.width = d + "px");
          a.style.display = "";
          "undefined" === typeof a.original_cols &&
            (-1 === a.container.classList.toString().indexOf("ti-col-")
              ? (a.original_cols = 1)
              : (a.original_cols = Trustindex.getColCount(a)));
          if (1 >= a.original_cols) return Trustindex.initHeaderNav(a);
          a.container.setAttribute(
            "class",
            "ti-widget-container ti-col-" + a.original_cols
          );
          Trustindex.vertical_separate_reviews(a);
          c = (b = a.container.offsetWidth > a.reviews_container.offsetWidth)
            ? 275
            : 300;
          ...
          b
            ? (350 > a.reviews_container.offsetWidth && (c = 0),
              a.container.setAttribute(
                "class",
                "ti-widget-container ti-col-" + (c + 1)
              ))
            : (1 > c && (c = 1),
              a.container.setAttribute(
                "class",
          ...
          a.querySelectorAll(
            ...
            let h = g.querySelector(".ti-verified-tooltip");
            if (!f) {
              let k = getComputedStyle(h);
              f = g.parentNode.offsetWidth - g.offsetLeft - 5;
              0 > parseInt(k.left) &&
                (f = g.offsetLeft - g.parentNode.offsetLeft - 5);
            }
            h.style.width = f + "px";
          });
          Trustindex.vertical_separate_reviews(a);
      ...
      resize_widgets: function () {
        return document
          .querySelectorAll(
            ".ti-widget:not(.ti-certificate):not(.ti-feed-widget):not(pre)"
          )
          .forEach(function (a) {
      ...
      vertical_separate_reviews: function (a) {
        ...
        if (a.getAttribute("data-column-vertical-separate")) {
          let d = a.container.querySelectorAll(
              '.ti-review-item:not([style*="display: none"])'
            ),
            f = a.container.querySelectorAll(
              '.ti-review-item[style*="display: none"]'
            );
          a.reviews_container_wrapper.innerHTML = "";
          for (var c = 0, e = []; c < b; c++)
            (e[c] = document.createElement("div")),
              e[c].setAttribute("class", "ti-column"),
              a.reviews_container_wrapper.appendChild(e[c]);
          Array.from(d)
            .sort(function (g, h) {
              g = g.getAttribute("data-index")
                ? parseInt(g.getAttribute("data-index"))
                : 0;
              h = h.getAttribute("data-index")
                ? parseInt(h.getAttribute("data-index"))
                : 1;
              return g - h;
            })
      ...
      verticalPositionElements: function (a) {
        ...
        let b = a.container.querySelector(".ti-footer"),
          c = a.querySelector(".ti-controls");
        if (
          0 <
          a.querySelectorAll(
            '.ti-read-more:not([style*="opacity: 0"]):not([style*="display: none"])'
          ).length
        ) {
          let e = a.reviews_container.querySelectorAll(
          ...
          e.forEach((d) => {
            d.textContainer = d
              .closest(".ti-review-item")
              .querySelector(
                d.parentNode.getAttribute("data-container") ||
                  ".ti-review-content .ti-inner"
              );
            d.textContainer && (d.textContainer.style.transition = "unset");
            d.click();
          });
          if (b && a.container.offsetWidth > a.reviews_container.offsetWidth) {
            let d = (a.container.offsetHeight - b.offsetHeight) / 2;
            a.container.style.alignItems = "flex-start";
            b.style.marginTop = d + "px";
          }
          c &&
            -1 !== [4, 5, 13, 14, 34, 44].indexOf(a.layout_id) &&
            (c.style.top = a.reviews_container.offsetHeight / 2 + "px");
          e.forEach((d) => {
            d.click();
            d.textContainer &&
              setTimeout(() => (d.textContainer.style.transition = ""), 1);
          });
      ...
      getVisibleReviewNum: function (a) {
        ...
        if (a.reviews_container.querySelector(".ti-review-item")) {
          let e = a.reviews_container.querySelector(
            '.ti-review-item:not([style*="display: none"])'
          );
          e &&
            (c = Math.floor(a.reviews_container.offsetWidth / e.offsetWidth));
        }
      ...
      resetPager: function (a) {
        a.pager_position = 0;
        a.pager_state = 0;
        return a.reviews_container_wrapper
          .querySelectorAll(".ti-review-item")
          .forEach((b) => b.animate({ left: 0 }, { fill: "both" }));
      },
      addCSS: function (a, b) {
              ...
              (e
                ...
                .forEach((d) => {
                  ...
                  d.classList.contains("active")
                    ? Trustindex.activePopups.push(d)
                    : ((d = Trustindex.activePopups.indexOf(d)),
                      -1 !== d && Trustindex.activePopups.splice(d, 1));
                }),
      ...
      popupCloseHandler: function (a) {
        if (
          ...
          a.target.matches(".ti-popup-header .ti-close-lg") ||
          a.target.matches(".ti-popup-widget.active")
        )
          a.preventDefault(),
      ...
      clickEventHandler: function (a) {
        if (a.target.matches(".ti-show-original-text")) {
          ...
          a = a.target;
          var b = JSON.parse(
            a.parentNode.querySelector('script[type="application/ld+json"]')
              .innerHTML
          );
          b = b.text || b;
          let c = a.parentNode,
          ...
          c.getAttribute("data-initial-height") &&
          parseInt(c.style.height) !==
            parseInt(c.getAttribute("data-initial-height"))
            ? (c.style.setProperty("height", "auto", "important"),
              c.style.setProperty("height", c.scrollHeight + "px", "important"))
            : ((a = e.closest(".ti-widget")),
              (b = a.querySelector(".ti-read-more .ti-read-more-collapse")) &&
                b.click(),
              Trustindex.setReadMore(a, 0));
        }
        return !0;
      },
        ...
        for (a = d.length - 1; 0 <= a; a--)
          if (f >= d[a])
            return (
              ...
              (d = 2 * a),
              1 < e && d++,
              c.replace("%d", e).replace("%s", b[d])
            );
        return e;
      },
      getScriptSelector: function (a) {
        return (
          'div[src*=".trustindex."][src*="' +
          a +
          '.js"],div[data-src*=".trustindex."][data-src*="' +
          a +
          '.js"],script[src*=".trustindex."][src*="' +
          a +
          '.js"]'
        );
      },
      getCDNUrl: function () {
        ...
        Trustindex.script &&
          Trustindex.script.src &&
          ((a = Trustindex.script.src.split("/")),
          a.pop(),
          (a = a.join("/") + "/"));
        -1 === a.indexOf("trustindex.") && (a = "https://cdn.trustindex.io/");
        return a;
      },
      getLoadMoreLimit: function (a) {
        return -1 === a.container.classList.toString().indexOf("ti-col-") ||
          81 == a.layout_id
          ? 5
          : 3 * Trustindex.getColCount(a);
      },
      ...
      getStarHtml: function (a) {
        ...
        0.25 <= a &&
          ((b =
            0.75 > a
              ? b + '<span class="ti-star h"></span>'
              : b + '<span class="ti-star f"></span>'),
          c++);
      ...
      loadSpriteImage: function (a) {
        ...
        let c =
            Trustindex.getWidgetUrl(b.getAttribute("data-pid")) + "sprite.jpg",
          e = 0,
          d = 0,
          f = 0;
        if (!a.classList.contains("ti-company-sprite-profile-image")) {
          ...
          if ("auto" === k.height)
            return setTimeout(() => Trustindex.loadSpriteImage(a), 100);
          e = h.getAttribute("data-index")
            ? parseInt(h.getAttribute("data-index"))
            : [].indexOf.call(h.parentNode.children, h) -
              h.parentNode.querySelectorAll(".ti-ai-summary-item").length;
          d = parseInt(k.height || "0");
          if (!d || isNaN(d)) d = 40;
          if ((b = b.querySelector(".ti-company-sprite-profile-image")))
            if (
              ((k = getComputedStyle(b)),
              (f = parseInt(k.height || "0")),
              !f || isNaN(f))
            )
              f = 65;
        }
        ...
        a.getAttribute("data-webp")
          ? Trustindex.isWebpSupported("lossy", (h) => {
      ...
      isWebpSupported: function (a, b) {
        if ("undefined" !== typeof Trustindex.cacheWebpSupported[a])
          return b(Trustindex.cacheWebpSupported[a]);
        let c = new Image();
        c.onload = () => {
