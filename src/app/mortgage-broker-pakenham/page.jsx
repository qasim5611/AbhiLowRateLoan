                              ...
                              <div className="is-content-justification-center is-layout-flex wp-container-1 wp-block-buttons">
                                <div className="wp-block-button has-custom-width wp-block-button__width-50">
                                  <a
                                    ...
                                    href="http://scoresbymortgagebroker.com.au/refinance-consultation/"
                                  >
                                    I want to refinance
                                  </a>
                                </div>
                                <div className="wp-block-button has-custom-width wp-block-button__width-50 is-style-outline">
                                  <a
                                    className="wp-block-button__link wp-element-button"
                                    href="http://scoresbymortgagebroker.com.au/buy-home-consultation/"
                                  >
                      ...
                      >
                        <div className="kt-row-column-wrap kt-has-2-columns kt-gutter-default kt-v-gutter-default kt-row-valign-top kt-row-layout-equal kt-tab-layout-inherit kt-m-colapse-left-to-right kt-mobile-layout-row">
                          <div className="wp-block-kadence-column inner-column-1 kadence-column_df85cb-a2">
                            <div className="kt-inside-inner-col">
                              <p>
                                Mortgage brokers can provide access to a far
                                wider range of lenders than a bank or other
                                lending institution, so they are the best choice
                                if you have complex needs or need to find
                                lenders who offer unique loan products.
                              </p>
                              <p>
                                They may be able to help those with bad credit
                                histories, non-standard income sources, and
                                other circumstances that might prevent them from
                                qualifying for a loan through a traditional
                                lender.
                              </p>
                              <p>
                                Furthermore, they can save you time and effort
                                by doing the legwork of finding lenders who may
                                be willing to approve your loan application. If
                                you require specialised loan products or have
                                complex financial circumstances, a mortgage
                                broker may be the best choice.
                              </p>
                              <p>
                          ...
                          <div className="wp-block-kadence-column inner-column-2 kadence-column_ff0f28-50">
                            <div className="kt-inside-inner-col">
                              ...
                              <p>
                                Pakenham is a popular metropolitan suburb
                                located in the south-east of Melbourne, and is
                                known for its relatively affordable property
                                prices. As of October 2022, the median house
                                purchase price for Pakenham is around $650k,
                                with an average rent of around $410 pw.
                              </p>
                              <p>
                                In 2021, we saw a significant increase in prices
                                with the median house price rising by
                                approximately $74K. This was largely reflective
                                of a wider trend across Australia in which
                                prices rose by 21.9% over the year to September
                                2021. However, experts believe that this upward
                                trend will cool off in 2022 with predictions of
                                more modest increases of between 5-6%.
                              </p>
                              <p>
                                As such, it’s likely that Pakenham’s property
                                prices will follow suit and remain fairly stable
                                throughout 2022. Potential buyers and renters
                                should keep in mind that as a metropolitan area
                                demand can be high so they should weigh up their
                                options carefully before making any decisions.
                                Additionally, there are other things to consider
                                when investing or renting such as local
