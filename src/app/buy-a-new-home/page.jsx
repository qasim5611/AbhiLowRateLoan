                            ...
                            >
                              <div className="kt-row-column-wrap kt-has-1-columns kt-gutter-default kt-v-gutter-default kt-row-valign-top kt-row-layout-equal kt-tab-layout-inherit kt-m-colapse-left-to-right kt-mobile-layout-row kb-theme-content-width">
                                <div className="wp-block-kadence-column inner-column-1 kadence-column_f51e5f-24">
                                  ...
                                  >
                                    <p>
                                      Purchasing a new home can cause a wide
                                      range of emotions. It can be daunting and
                                      very challenging.
                                      <br />
                                      <br />
                                      There are too many things to consider,
                                      including how much you can afford, the
                                      type of house you desire, and all those
                                      extra appointments you’ll need to fit into
                                      your busy schedule.
                                      <br />
                                      <br />
                                      Our mortgage brokers at Low Rate Home Loan
                                      can help you with all aspects of the home
                                      loan process
                                      <br />
                                      <br />
                                      Establishing how much you can afford to
                                      borrow and the options available to you.
                                      <br />
                                      <br />
                                      Helping you apply for the Government’s
                                      First Home Owners Grant if you are
                                      eligible.
                                      <br />
                                      <br />
                                      Determining what fees/costs are involved
                                      including stamp duty, legal fees, building
                                      and pest inspections, property valuation
                                      and lender´s mortgage insurance.
                                      <br />
                                      <br />
                                      Finding what type of loan is right for you
                                      from hundreds of different home loans from
                                      our wide panel of lenders.
                                      <br />
                                      <br />
                                      Completing all the necessary documents.
                                      <br />
                                      <br />
                                      Running around for you, from pre-approval
                                      right through to settlement of your new
                                      home so you can spend more time looking
                                      for the right home.
                                    </p>
                                  </div>
                                </div>
