              ...
              <div className="kt-inside-inner-col">
                ...
                <div className="wpsm_panel-group" id="wpsm_accordion_1713">
                  ...
                  <div className="wpsm_panel wpsm_panel-default">
                    ...
                    >
                      <div className="wpsm_panel-body">
                        ...
                        eligibility for a mortgage. It helps you understand your
                        budget and strengthens your position when making an
                        offer on a property.{" "}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="wpsm_panel wpsm_panel-default">
                    ...
                    >
                      <div className="wpsm_panel-body">
                        ...
                        mortgage. They include appraisal fees, legal fees, stamp
                        duty, and other administrative costs.{" "}
                      </div>
                    </div>
                  </div>
                  {/* Inner panel End */}
                  ...
                  <div className="wpsm_panel wpsm_panel-default">
                    ...
                    >
                      <div className="wpsm_panel-body">
                        The right mortgage term depends on your financial goals
                        and circumstances. Our mortgage broker Scoresby Firm can
                        help you evaluate your options and choose the term that
                        suits you best.{" "}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="wpsm_panel wpsm_panel-default">
                    ...
                    >
                      <div className="wpsm_panel-body">
                        A mortgage offset account is a savings account linked to
                        your mortgage. The balance in the account offsets the
                        interest charged on your mortgage, potentially reducing
                  ...
                  <div className="wpsm_panel wpsm_panel-default">
                    ...
                    >
                      <div className="wpsm_panel-body">
                        ...
                        and interest rates may differ compared to a mortgage for
                        a primary residence.{" "}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="wpsm_panel wpsm_panel-default">
                    ...
                    >
                      <div className="wpsm_panel-body">
                        ...
                        throughout the loan term, while a variable-rate mortgage
                        has an interest rate that can fluctuate.{" "}
                      </div>
                    </div>
                  </div>
                  {/* Inner panel End */}
                  ...
                  <div className="wpsm_panel wpsm_panel-default">
                    ...
                    >
                      <div className="wpsm_panel-body">
                        ...
                        mortgage. It is typically required if your loan-to-value
                        ratio (LVR) is higher than 80%.{" "}
                      </div>
                    </div>
                  </div>
                  {/* Inner panel End */}
                  ...
                  <div className="wpsm_panel wpsm_panel-default">
                    ...
                    >
                      <div className="wpsm_panel-body">
                        ...
                        additional documentation to assess your income stability
                        and affordability.{" "}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="wpsm_panel wpsm_panel-default">
                    ...
                    >
                      <div className="wpsm_panel-body">
                        ...
                        to renegotiate the mortgage terms, switch to a variable
                        rate, or refinance with another lender.
                      </div>
                    </div>
                  </div>
                  {/* Inner panel End */}
                  ...
                  <div className="wpsm_panel wpsm_panel-default">
                    ...
                    >
                      <div className="wpsm_panel-body">
                        ...
                        licence, or other government-issued photo ID. 2. Address
                        Proof: Utility bills, bank statements, or any other
                        official documents with your current address. 3. Income
                        Proof: Pay slips from your current employer. 4. Tax
                        Returns: The previous two years' statement of tax
